                                            ...
                                            @foreach($brands as $brand)
                                                <li>
                                                    <div class="form-check ps-0 custome-form-check">
                                                        <input class="checkbox_animated check-it" id="br{{$brand->id}}" name="brands" @if(in_array($brand->id, explode(',',$q_brands))) checked="checked" @endif value="{{$brand->id}}" type="checkbox" onchange="filterProductsByBrands(this)">
                                    ...
                                    <div class="accordion-body category-scroll">
                                        <ul class="category-list">
                                            @foreach($categories as $category)
                                                <li>
                                                    <div class="form-check ps-0 custome-form-check">
                                                        <input class="checkbox_animated check-it" id="ct{{$category->id}}" name="categories" type="checkbox" @if(in_array($category->id, explode(',',$q_categories))) checked="checked" @endifvalue="{{$category->id}}" onchange="filterProductsByCategories(this)">
...
{{--                    </nav>--}}
    ...
    <form id="frmFilter" method="GET">
        ...
        <input type="hidden" name="size" id="page" value="{{$size}}">
...
@push("scripts")
    <script>
        ...
        function filterProductsByBrands() {
            var brands = "";
            $("input[name='brands']:checked").echo(function (){
                if (brands == ""){
                    brands += this.value;
                }
                else {
        ...
        function filterProductsByCategories() {
            var brands = "";
            $("input[name='categories']:checked").echo(function (){
                if (categories == ""){
